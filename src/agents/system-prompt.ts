...
function buildSkillsSection(params: {
  ...
  return [
    ...
    "1. List /root/.openclaw/workspace/playbooks/*/PLAYBOOK.md",
    "2. Check each PLAYBOOK.md frontmatter `triggers` list against the user message.",
    "3. If a trigger matches, read that PLAYBOOK.md and follow its steps.",
