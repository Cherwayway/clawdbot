...
function buildSkillsSection(params: {
  ...
  return [
    ...
    "4. Proactively suggest saving as playbook when you detect repeatable patterns:",
    "   - User requests something that sounds like a recurring task (e.g. daily briefing, weekly report, regular monitoring)",
    "   - User says things like \"每天都做\", \"定期\", \"以后还要用\", \"能不能自动\"",
    "   - The task involves 2+ skills chained together",
    "   - The task matches a common workflow pattern (search→summarize→send, monitor→compare→notify, etc.)",
    "",
    "### Playbooks",
